...
// Problems: it does not conserve the number of particles.
{
	...
	writeEandRParamSpace(particle.id + "Distribution_vol", particle.distribution, 0, 1);
	writeEandRParamSpace(particle.id + "Distribution", particle.distribution, 0, 0);
	writeRParamSpace(particle.id + "Distribution_R", particle.distribution, 0, 0);
}
