...
void nonThermalRadiation(State& st, const std::string& filename)
{
	...
	writeEandRParamSpace("NTphotonDensity", st.ntPhoton.distribution, 0, 0);
	writeRParamSpace("NTphotonDensity_R", st.ntPhoton.distribution, 0, 0);
	writeEandRParamSpace("opticalDepth_gg", st.tau_gg, 0, 0);
