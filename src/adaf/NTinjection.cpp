...
////////////////////////////////////////////////////////
	...
	writeEandRParamSpace(p.id + "Injection_vol", p.injection, 0, 1);
	writeEandRParamSpace(p.id + "Injection", p.injection, 0, 0);
	writeRParamSpace(p.id + "Injection_R", p.injection, 0, 0);
}
